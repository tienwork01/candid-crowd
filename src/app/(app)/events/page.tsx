...
import { HostTipCard, HostUserCard } from "@/features/host/components";
import {
  EventsListClient,
      ...
      <header className="host-events__header">
        <div className="host-events__context-bar">
          <span className="host-events__status-badge">
            <span className="host-events__status-dot" aria-hidden="true" />
            <span>{t("eventsEyebrow")}</span>
          </span>
          <span className="host-events__badge-sep" aria-hidden="true">
            •
          </span>
          <span className="host-events__live-text">{t("realtimeReady")}</span>
        </div>

        <div className="host-events__heading">
          <div className="host-events__title-group">
            <h1 id="events-title">{t("eventsTitle")}</h1>
            <p className="host-events__description">{t("eventsDescription")}</p>
          </div>
          <Link className="button host-events__create-btn" href="/events/new">
